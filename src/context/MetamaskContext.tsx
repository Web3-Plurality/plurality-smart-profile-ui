...
import { Snap } from '../globalTypes';

import { detectSnaps } from '../common/metamask';
import { getSnap } from '../common/snap';
import { isFlask } from '../common/metamask';
...
const reducer: Reducer<MetamaskState, MetamaskDispatch> = (state, action) => {
    switch (action.type) {
        ...
        case MetamaskActions.SetInfoMessage:
            return {
                ...state,
